# Online-Retail-Sales
This project is about an online retail store analysis using Power BI.
## Findings.

### 1. Revenue Trend for Year 2011.

The CEO requested a trend of the revenue to see if there is any
seasonality in the store sales. 
My analysis shows that there are some months of the year where
...
performing. This data does not include the UK as the country already has high demand and the focus is on the countries where demand can be increased. The analysis
...
The map chart shows the regions that have generated the most revenue compared with
